  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center bg-blue-200/30 border-4 border-blue-500 rounded-3xl p-20">
        ...
        <div className="flex flex-col items-center gap-5">
          <video ref={videoRef} onPlay={handlePlay} onPause={handlePause} onSeeked={handleSeek} controls muted className="w-2/5">
