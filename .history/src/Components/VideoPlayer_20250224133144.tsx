  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center bg-blue-200/30 border-4 border-blue-500 rounded-3xl p-20">
